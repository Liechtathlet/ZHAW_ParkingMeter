...
public class ParkingMeterControllerImpl implements ParkingMeterController {
	...
	// // Methode zur Ausgabe aller gebuchten ParkingLots
	// // @Override
	// // Rückgabe Liste??? --> über alle Parkplätze iterieren und für jeden
	// // Parkplatz Nummer und
	// // bezahlter Betrag speichern.
	// public ParkingLot getBookedParkingLot() {
	// ParkingLot parkingLot = null;
	//
	// for (ParkingLot pl : parkingMeter.parkingLots) {
	// if ()
